...
export const clearConversationsUnreadStatus: (conversationTypes: number[], lines: number[]) => void;
...
export const clearFriendRequest: (incomming: number, beforeTime: number) => void;
export const deleteFriendRequest: (userId: string, incomming: number) => void;
...
export const kickoffPCClient: (clientId: string, successCB: Function, failCB: Function) => void;
