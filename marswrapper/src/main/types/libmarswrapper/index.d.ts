...
export const isTcpShortLink: () => boolean;
...
export const disconnect: (clear: boolean) => void;
...
export const beginTransaction: () => boolean;
export const commitTransaction: () => boolean;
export const rollbackTransaction: () => boolean;
...
export const searchConversationEx2: (keyword: string, conversationTypes: number[], lines: number[], conTyps: number[], stringTime: number, endTime: number, desc: boolean, limit: number, offset: number, onlyMentionedMsg: number) => string;
...
export const setLastReceivedMessageUnRead: (conversationStr: string) => void;
...
export const getMessagesEx2V2: (conversationTypes: number[], lines: number[], statuss: number[], fromIndex: number, direction: boolean, count: number, withUser: string, successCB: Function, errorCB: Function) => void;
export const getMessagesByTimestampV2: (conversationStr: string, cntTypes: number[], timestamp: number, before: number, count: number, withUser: string, successCB: Function, errorCB: Function) => void;
export const getMessagesByStatusV2: (conversationStr: string, statuss: number[], fromIndex: number, before: number, count: number, withUser: string, successCB: Function, errorCB: Function) => void;
...
export const getRemoteMessages: (conversationStr: string, startMsgUid: string, count: number, successCB: Function, errorCB: Function) => void;
...
export const getMessageByUid: (messageUid: number) => string;
...
export const updateRemoteMessageContent: (messageUid: string, messagePayload: string, distribute: number, updateLocal: number, successCB: Function, errorCB: Function) => void;
...
export const deleteMessage: (messageId: number) => number;
export const batchDeleteMessages: (messageUids: number[]) => number;
...
export const clearAllMessages: (removeConversation: number) => void;
export const clearRemoteConversationMessages: (conversationStr: string, successCB: Function, errorCB: Function) => void;
export const insertMessage: (conversationStr: string, from: string, content: string, status: number, notify: number, toUsers: string[], serverTime: number) => string;
...
export const getFriendRequest: (userId: string, incoming: number) => string;
...
export const handleFriendRequest: (userId: string, accept: number, successCB: Function, errorCB: Function) => void;
export const isBlackListed: (userId: string) => number;
export const getBlackList: (refresh: boolean) => string;
export const setBlackList: (userId: string, isBlackListed: number, successCB: Function, errorCB: Function) => void;
...
export const createGroup: (groupId: string, groupName: string, portrait: string, groupExtra: string, members: string[], lines: number[], content: string, successCB: Function, errorCB: Function) => void;
...
export const setGroupManager: (groupId: string, isSet: number, members: string[], lines: number[], content: string, successCB: Function, errorCB: Function) => void;
export const muteGroupMember: (groupId: string, isSet: number, members: string[], lines: number[], content: string, successCB: Function, errorCB: Function) => void;
export const allowGroupMember: (groupId: string, isSet: number, members: string[], lines: number[], content: string, successCB: Function, errorCB: Function) => void;
...
export const isListenedChannel: (channelId: string , successCB: Function, errorCB: Function) => void;
...
export const isSupportBigFilesUpload: () => boolean;
export const forcePresignedUrlUpload: () => boolean;
...
export const isCommercialServer: () => boolean;
export const isReceiptEnabled: () => boolean;
export const isGroupReceiptEnabled: () => boolean;
export const isGlobalDisableSyncDraft: () => boolean;
export const isEnableUserOnlineState: () => boolean;
...
export const getConversationFiles: (conversationStr: string, fromUser: string, messageUid: string, order: boolean, count: Number, successCB: Function, errorCB: Function) => void;
export const getMyFiles: (messageUid: string, order: boolean, count: Number, successCB: Function, errorCB: Function) => void;
export const deleteFileRecord: (messageUid: string, successCB: Function, errorCB: Function) => void;
export const searchFiles: (keyword: string, conversationStr: string, fromUser: string, messageUid: string, order: boolean, count: number, successCB: Function, errorCB: Function) => void;
export const searchMyFiles: (keyword: string, messageUid: string, order: boolean, count: number, successCB: Function, errorCB: Function) => void;
...
export const isEnableSecretChat: () => boolean;
export const isUserEnableSecretChat: () => boolean;
